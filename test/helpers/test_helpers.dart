...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<BitcoinService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
...
MockBitcoinService getAndRegisterBitcoinService() {
  _removeRegistrationIfExists<BitcoinService>();
  final service = MockBitcoinService();
  locator.registerSingleton<BitcoinService>(service);
  return service;
}
// @stacked-mock-create
